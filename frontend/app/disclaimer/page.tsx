    ...
    <>
      ...
      <article className="py-14 bg-white">
        <div className="max-w-3xl mx-auto px-4 prose prose-lg prose-headings:font-display prose-headings:text-brand-text prose-p:text-brand-muted prose-li:text-brand-muted">
          ...
          <p>While we endeavour to verify RERA registration of all projects listed, buyers must independently verify RERA registration status on the official Haryana RERA portal at <a href="https://haryanarera.gov.in" target="_blank" rel="noopener noreferrer" className="text-brand-accent">haryanarera.gov.in</a> before making any booking. RERA registration status may change, and {settings.siteName} cannot be held responsible for any lapses in RERA compliance by developers.</p>
