...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/industrial-plots-bhiwadi`;
  return {
    title: `Industrial Plots in Bhiwadi 2025 | RIICO Allocation | Manufacturing | ${settings.siteName}`,
    description: `RIICO industrial plots in Bhiwadi for manufacturing, warehousing and light industry. Government-backed allocation. 200 sqm from ₹50L. 60% cheaper than Gurgaon/Manesar. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'industrial plots bhiwadi, riico industrial plots bhiwadi, bhiwadi factory plot, manufacturing plot bhiwadi',
    openGraph: { title: `Industrial Plots in Bhiwadi 2025 | RIICO Allocation | Manufacturing | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Industrial Plots in Bhiwadi — RIICO</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🏭 Industrial</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Industrial Plots in Bhiwadi — RIICO</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">RIICO industrial plots in Bhiwadi for manufacturing, warehousing and light industry. Government-backed allocation. 200 sqm from ₹50L. 60% cheaper than Gurgaon/Manesar.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Industrial Plots in Bhiwadi — RIICO</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Industrial Plots in Bhiwadi — RIICO</h2>
