...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/flats-in-bhiwadi`;
  return {
    title: `Flats in Bhiwadi 2025 | 1, 2 & 3 BHK from ₹28 Lakh | ${settings.siteName}`,
    description: `Complete list of 1, 2 and 3 BHK flats in Bhiwadi from ₹28 Lakh. Compare Omaxe, Ashiana, GLS, Avalon, Adani — all RERA verified projects on Alwar Bypass and NH-48. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'flats in bhiwadi, bhiwadi flats price, 1 bhk bhiwadi, 2 bhk bhiwadi, 3 bhk bhiwadi',
    openGraph: { title: `Flats in Bhiwadi 2025 | 1, 2 & 3 BHK from ₹28 Lakh | ${settings.siteName}`, url: pageUrl, type: 'website' },
  ...
  return (
    <>
      ...
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🏢 All Flats</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Flats in Bhiwadi</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Complete list of 1, 2 and 3 BHK flats in Bhiwadi from ₹28 Lakh. Compare Omaxe, Ashiana, GLS, Avalon, Adani — all RERA verified projects on Alwar Bypass and NH-48.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Flats in Bhiwadi</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Flats in Bhiwadi</h2>
