...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/nh-48-bhiwadi-projects`;
  return {
    title: `NH-48 Bhiwadi Projects 2025 | Delhi-Jaipur Highway Properties | ${settings.siteName}`,
    description: `Properties on NH-48 (Delhi-Jaipur Highway) in Bhiwadi. Ashiana, Supertech, Adani — 1 BHK from ₹38L. Best appreciation due to highway frontage. 35 km to Gurgaon. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'nh 48 bhiwadi projects, nh 48 property bhiwadi, delhi jaipur highway bhiwadi flats',
    openGraph: { title: `NH-48 Bhiwadi Projects 2025 | Delhi-Jaipur Highway Properties | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">NH-48 Projects — Bhiwadi</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🏎️ Highway Frontage</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">NH-48 Projects — Bhiwadi</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Properties on NH-48 (Delhi-Jaipur Highway) in Bhiwadi. Ashiana, Supertech, Adani — 1 BHK from ₹38L. Best appreciation due to highway frontage. 35 km to Gurgaon.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">NH-48 Projects — Bhiwadi</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — NH-48 Projects — Bhiwadi</h2>
