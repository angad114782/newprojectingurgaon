...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/bhiwadi-extension-projects`;
  return {
    title: `Bhiwadi Extension Projects 2025 | Most Affordable | From ₹28L | ${settings.siteName}`,
    description: `Most affordable new launch residential projects in Bhiwadi Extension. Ratan Pearl, Supertech — 1 BHK from ₹28L. PMAY subsidy eligible. Upcoming zone with strong appreciation. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'bhiwadi extension projects, bhiwadi extension flats, affordable bhiwadi 2025',
    openGraph: { title: `Bhiwadi Extension Projects 2025 | Most Affordable | From ₹28L | ${settings.siteName}`, url: pageUrl, type: 'website' },
...
export default async function Page() {
  const params: any = {};
  params.corridor = 'Bhiwadi Extension';
  params.limit = 50;
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Bhiwadi Extension Projects</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🌱 Upcoming Zone</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Bhiwadi Extension Projects</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Most affordable new launch residential projects in Bhiwadi Extension. Ratan Pearl, Supertech — 1 BHK from ₹28L. PMAY subsidy eligible. Upcoming zone with strong appreciation.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Bhiwadi Extension Projects</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Bhiwadi Extension Projects</h2>
