...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/khushkhera-bhiwadi-projects`;
  return {
    title: `Khushkhera Bhiwadi Projects 2025 | RIICO Belt | Highest Rental Yield | ${settings.siteName}`,
    description: `Residential projects in Khushkhera RIICO area. Eldeco Bhiwadi Greens — 1 BHK from ₹32L. 5.5% rental yield — highest in Bhiwadi belt. 1,500+ RIICO units nearby. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'khushkhera bhiwadi, khushkhera riico projects, khushkhera flats, riico belt bhiwadi',
    openGraph: { title: `Khushkhera Bhiwadi Projects 2025 | RIICO Belt | Highest Rental Yield | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Khushkhera Bhiwadi — RIICO Industrial Belt</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">⚙️ RIICO Belt</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Khushkhera Bhiwadi — RIICO Industrial Belt</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Residential projects in Khushkhera RIICO area. Eldeco Bhiwadi Greens — 1 BHK from ₹32L. 5.5% rental yield — highest in Bhiwadi belt. 1,500+ RIICO units nearby.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Khushkhera Bhiwadi — RIICO Industrial Belt</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Khushkhera Bhiwadi — RIICO Industrial Belt</h2>
