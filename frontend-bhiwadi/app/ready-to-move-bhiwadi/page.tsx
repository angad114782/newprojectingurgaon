...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/ready-to-move-bhiwadi`;
  return {
    title: `Ready to Move Property in Bhiwadi 2025 | Immediate Possession | ${settings.siteName}`,
    description: `Ready to move residential property in Bhiwadi. Ashiana Housing and more — immediate possession, instant rental income. 1 BHK from ₹38L. OC received projects only. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'ready to move bhiwadi, immediate possession bhiwadi, ready flats bhiwadi',
    openGraph: { title: `Ready to Move Property in Bhiwadi 2025 | Immediate Possession | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Ready to Move Property — Bhiwadi</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🔑 Immediate Possession</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Ready to Move Property — Bhiwadi</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Ready to move residential property in Bhiwadi. Ashiana Housing and more — immediate possession, instant rental income. 1 BHK from ₹38L. OC received projects only.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Ready to Move Property — Bhiwadi</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Ready to Move Property — Bhiwadi</h2>
