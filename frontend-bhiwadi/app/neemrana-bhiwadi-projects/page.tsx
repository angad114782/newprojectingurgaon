...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/neemrana-bhiwadi-projects`;
  return {
    title: `Neemrana Bhiwadi Projects 2025 | Near Japanese Zone | Premium Housing | ${settings.siteName}`,
    description: `Premium housing near Neemrana Japanese Industrial Zone — 50+ Japanese MNCs including Honda, Panasonic, Daikin. Expat demand, 5.8% rental yield. BPTP, premium developers. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'neemrana bhiwadi projects, neemrana property, japanese zone neemrana housing, neemrana nh 48',
    openGraph: { title: `Neemrana Bhiwadi Projects 2025 | Near Japanese Zone | Premium Housing | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Neemrana Projects — Near Japanese Industrial Zone</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🇯🇵 Japanese Zone</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Neemrana Projects — Near Japanese Industrial Zone</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Premium housing near Neemrana Japanese Industrial Zone — 50+ Japanese MNCs including Honda, Panasonic, Daikin. Expat demand, 5.8% rental yield. BPTP, premium developers.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Neemrana Projects — Near Japanese Industrial Zone</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Neemrana Projects — Near Japanese Industrial Zone</h2>
