...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/tapukara-bhiwadi-projects`;
  return {
    title: `Tapukara Bhiwadi Projects 2025 | Near Honda Plant | Flats from ₹30L | ${settings.siteName}`,
    description: `Residential projects in Tapukara near Honda Plant. GLS Bhiwadi Residency and more — 1 BHK from ₹30L. Highest rental demand from Honda, Tapukara RIICO professionals. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'tapukara bhiwadi projects, tapukara flats, honda plant tapukara property',
    openGraph: { title: `Tapukara Bhiwadi Projects 2025 | Near Honda Plant | Flats from ₹30L | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Tapukara Bhiwadi Projects</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">🏭 Honda Zone</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Tapukara Bhiwadi Projects</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Residential projects in Tapukara near Honda Plant. GLS Bhiwadi Residency and more — 1 BHK from ₹30L. Highest rental demand from Honda, Tapukara RIICO professionals.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Tapukara Bhiwadi Projects</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Tapukara Bhiwadi Projects</h2>
