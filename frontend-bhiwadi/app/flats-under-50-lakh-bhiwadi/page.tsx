...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${siteUrl}/flats-under-50-lakh-bhiwadi`;
  return {
    title: `Flats Under 50 Lakh in Bhiwadi 2025 | 2 BHK Options | Best Value | ${settings.siteName}`,
    description: `Best 1 and 2 BHK flats in Bhiwadi under ₹50 Lakh. Ratan Pearl, Supertech, GLS, Omaxe — multiple options under budget. RERA verified, PMAY eligible. Free site visit. Zero brokerage. RERA verified. Call ${settings.phone}.`,
    keywords: 'flats under 50 lakh bhiwadi, bhiwadi flats 50 lakh, affordable 2 bhk bhiwadi',
    openGraph: { title: `Flats Under 50 Lakh in Bhiwadi 2025 | 2 BHK Options | Best Value | ${settings.siteName}`, url: pageUrl, type: 'website' },
    ...
    <>
      <nav className="bg-brand-mint/30 border-b border-brand-border/40 py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm text-brand-muted">
          ...
          <span className="text-brand-dark font-medium">Flats Under 50 Lakh in Bhiwadi</span>
        </div>
      </nav>
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <span className="inline-block bg-brand-accent/20 text-brand-accent text-sm font-semibold px-4 py-1.5 rounded-full mb-4">💰 Under ₹50L</span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight mb-4">Flats Under 50 Lakh in Bhiwadi</h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8">Best 1 and 2 BHK flats in Bhiwadi under ₹50 Lakh. Ratan Pearl, Supertech, GLS, Omaxe — multiple options under budget. RERA verified, PMAY eligible.</p>
      ...
      <section className="py-14 bg-brand-mint/20" id="projects">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-display font-bold text-brand-text mb-2 text-center">Flats Under 50 Lakh in Bhiwadi</h2>
      ...
      <section className="py-16 bg-brand-dark" id="lead-form">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-display font-bold text-white mb-3">Get Property Details — Flats Under 50 Lakh in Bhiwadi</h2>
